...
list_data = {
    ...
    'td_infant.deliverycomplications': [
        ...
        ('Chorioamnioitis or sus. chorioamnionitis', 'Chorioamnioitis or sus. chorioamnionitis'),
    ...
    'td_infant.maternaldiagnoseslist': [
        ('Pneumonia', 'Pneumonia'),
        ('Chlamydia', 'Chlamydia'),
    ...
    'td_infant.maternalhospitalization': [
        ('Pneumonia or other respiratory disease',
         'Pneumonia or other respiratory disease'),
        (NOT_APPLICABLE, 'Not Applicable'),
        ('Other, specify', 'Other, specify')
    ],
    'td_infant.maternalmedications': [
