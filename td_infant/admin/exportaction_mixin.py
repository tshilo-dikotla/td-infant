...
class ExportActionMixin:
    ...
    def export_as_csv(self, request, queryset):
        ...
        if getattr(queryset[0], 'infant_visit', None):
        ...
        for obj in queryset:
            ...
            if getattr(obj, 'infant_visit', None):
                obj_data['visit_code'] = obj.infant_visit.visit_code
    ...
    def get_consent_datetime(self, model_obj):
        ...
        if consent_version:
            try:
                infant_consent = subject_consent_cls.objects.get(
